...
export const tracks: Track[] = [
  {
    ...
    why:
      "The single highest-leverage move is hands-on AI/agent fluency fused with your existing security edge (Track 7). Free canon — Karpathy's Zero to Hero, Hugging Face's LLM/Agents/smol courses, DeepLearning.AI short courses — covers roughly 70% of this track and is current; pay selectively for at most one evals course. Evals are both an AI-engineering skill and product work, a two-track twofer directly relevant to AI-SOC quality. Since you will build with AI assistance, mastery of agentic coding tools is a force multiplier.",
    skillIds: [
      "transformers",
      "tokenization",
      "rag",
  ...
  },
  {
    ...
    why:
      "You are aiming at founding/technical roles, not climbing a PM ladder, so heavy PM certifications and Reforge ($1,995 USD/year) are overrated for you; the spec says prefer books plus targeted cohorts. The Mom Test, INSPIRED and Continuous Discovery Habits carry the core craft, Lenny's Newsletter keeps it current (about half of 2026 content is AI-adjacent), and Aman Khan's AI PM Playbook is the one cohort worth considering for AI-PM credibility. Prototyping tools let a non-designer show rather than tell.",
  ...
  },
  {
    ...
    why:
      "Your unfair advantage is the intersection: most AI engineers cannot speak CISO. Founder-led sales is the canonical early-stage motion and Founding Sales (free online) is its handbook; April Dunford's Obviously Awesome and Sales Pitch give you positioning and pitch structure; MEDDPICC is the framework most relevant to enterprise security deals; Never Split the Difference and Getting to Yes cover negotiation. Selling to CISOs (budget cycles, procurement, champions, POCs) has no single canonical book — it is a gap to fill via practitioner blogs and your own network.",
  ...
  },
  {
    id: "T7_DOMAIN",
    code: "T7",
    name: "Domain Expertise: AI Security & Your Wedge",
    goal:
    ...
    why:
      "Your unfair advantage is the intersection, not any single track: most AI engineers cannot speak CISO, most security people cannot build agents. The wedge 'securing agents / non-human identity / AI-for-SOC' is where your 8200 + solutions-architect background compounds — Track 7 is your moat. The frameworks (OWASP LLM and Agentic Top 10, MITRE ATLAS, NIST AI RMF) are free must-reads; SPIFFE/SPIRE with OAuth 2.1 token exchange, the MCP authorization spec and WIMSE are your sharpest wedge; Gandalf, HackAPrompt and HTB's AI Red Teamer path build hands-on credibility. Certifications are deliberately de-emphasized (CISSP/OSCP skip); HTB Certified AI Red Teamer is the one credential worth considering. Tel Aviv gives you Cyber Week TAU, DefenseTech Week and Cybertech on your doorstep in a defense-tech sector that grew from 160 to 312 companies in under a year.",
    skillIds: [
      "appsec",
      "nhi",
      "workload-identity",
  ...
  },
  {
    ...
    why:
      "You should learn by building in public, not by collecting credentials: your profile (senior, generalist, not a researcher, product-oriented) means your ROI is in demonstrable artifacts and a public reputation, so every other track is anchored to portfolio outputs and weekly published posts. This library over-collects by design, so you must choose depth over breadth — pick one path variant and treat the rest as backlog. Keep this track lightweight: curate, don't over-invest.",
